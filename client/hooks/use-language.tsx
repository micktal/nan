...
export function LanguageProvider({ children }: LanguageProviderProps) {
  ...
  useEffect(() => {
    ...
    if (
      savedLanguage &&
      AVAILABLE_LANGUAGES.find((l) => l.code === savedLanguage)
    ) {
  ...
  return (
    <LanguageContext.Provider
      value={{ language, languageConfig, setLanguage, t }}
    >
      <div dir={languageConfig.rtl ? "rtl" : "ltr"}>{children}</div>
    </LanguageContext.Provider>
  );
}
...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "home.description":
      "Avant d'accéder au site, vous devez suivre une courte formation aux règles de sécurité essentielles.",
    ...
    "profile.subtitle":
      "Choisissez le profil qui correspond le mieux à votre visite",
  ...
  en: {
    ...
    "home.description":
      "Before accessing the site, you must complete a short training on essential safety rules.",
  ...
  de: {
    ...
    "home.description":
      "Bevor Sie das Gelände betreten, müssen Sie eine kurze Schulung zu den wichtigsten Sicherheitsregeln absolvieren.",
    ...
    "profile.subtitle":
      "Wählen Sie das Profil, das am besten zu Ihrem Besuch passt",
    ...
    "qcm.failed":
      "Unzureichende Punktzahl. Wir empfehlen, die Schulung zu wiederholen.",
  ...
  es: {
    ...
    "home.description":
      "Antes de acceder al sitio, debe completar una breve formación sobre las reglas de seguridad esenciales.",
