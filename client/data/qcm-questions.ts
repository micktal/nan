...
export const baseQuestions: QCMQuestion[] = [
  ...
  },
  {
    ...
    options: {
      fr: ["Interdiction", "Danger", "Obligation", "Information"],
      en: ["Prohibition", "Danger", "Obligation", "Information"],
      de: ["Verbot", "Gefahr", "Pflicht", "Information"],
      es: ["Prohibición", "Peligro", "Obligación", "Información"],
    },
    correct: 1,
  },
];
...
export const driverQuestions: QCMQuestion[] = [
  ...
  },
  {
    ...
    options: {
      fr: ["50 km/h", "30 km/h", "20 km/h", "10 km/h"],
      en: ["50 km/h", "30 km/h", "20 km/h", "10 km/h"],
      de: ["50 km/h", "30 km/h", "20 km/h", "10 km/h"],
      es: ["50 km/h", "30 km/h", "20 km/h", "10 km/h"],
    },
    correct: 2,
  },
  {
...
export const technicianQuestions: QCMQuestion[] = [
  ...
  },
  {
    ...
    options: {
      fr: ["1 mètre", "2 mètres", "3 mètres", "5 mètres"],
      en: ["1 meter", "2 meters", "3 meters", "5 meters"],
      de: ["1 Meter", "2 Meter", "3 Meter", "5 Meter"],
      es: ["1 metro", "2 metros", "3 metros", "5 metros"],
    },
    correct: 1,
  },
  {
...
export const administrativeQuestions: QCMQuestion[] = [
  {
    ...
    options: {
      ...
      en: ["No one", "A site safety manager", "Anyone", "Only a worker"],
      de: [
        "Niemand",
...
function ensureAllLanguages(question: QCMQuestion): QCMQuestion {
  ...
  allLanguages.forEach((lang) => {
    if (!questionText[lang]) {
      questionText[lang] =
        questionText.fr || Object.values(questionText)[0] || "";
    }
  });
  ...
  if (explanation) {
    ...
    allLanguages.forEach((lang) => {
      if (!explanation![lang]) {
        explanation![lang] =
          explanation!.fr || Object.values(explanation!)[0] || "";
      }
    });
  }
