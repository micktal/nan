  ...
  useEffect(() => {
    const interval = setInterval(() => {
      const newEvent: AccessEvent = {
        ...
        profile: ["Chauffeur", "Nettoyage", "Technique", "Administratif"][
          Math.floor(Math.random() * 4)
        ],
        status:
          Math.random() > 0.1
      ...
      setLiveStats((prev) => ({
        ...prev,
        authorized:
          newEvent.status === "authorized"
            ? prev.authorized + 1
            : prev.authorized,
        denied:
          newEvent.status !== "authorized" ? prev.denied + 1 : prev.denied,
        onSite:
          newEvent.status === "authorized" ? prev.onSite + 1 : prev.onSite,
      }));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="px-4 py-4">
        {activeTab === "scanner" && (
          <QRScanner mode="mobile" onScanResult={handleScanResult} />
        )}
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      type: "unauthorized",
                      message:
                        "Tentative d'accès non autorisée - Zone Production",
                      time: "Il y a 12 min",
                      priority: "critical",
                    },
                    {
